...
def solve_inverse_grad_dsc( x =1/4, y =1/4, z_init = 30, target_value = 15, loss_function = loss_function, learning_rate = 0.01, num_iterations = 1000,eps = 1e-4,max_iters_for_solve = 500, progress_report = False) :
    z = z_init
